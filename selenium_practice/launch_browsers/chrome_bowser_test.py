# Tutorial: Launching Chrome Browser with Selenium
# --------------------------------------------------
# This script demonstrates how to launch Google Chrome using Selenium WebDriver
...
#
# In this example, the script opens Google, searches for "Automation step by step",
