...
class WebDriver(BaseWebDriver):
    ...
    def _check_if_window_handle_is_current(self, windowHandle: str) -> None:
        ...
        if windowHandle != "current":
            warnings.warn("Only 'current' window is supported for W3C compatible LaunchBrowsers.", stacklevel=2)
    ...
    def set_window_rect(self, x=None, y=None, width=None, height=None) -> dict:
        ...
        LaunchBrowsers; other LaunchBrowsers should use `set_window_position` and
        `set_window_size`.
