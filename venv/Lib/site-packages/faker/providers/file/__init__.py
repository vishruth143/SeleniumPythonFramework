...
class Provider(BaseProvider):
    ...
    application_mime_types: ElementsType[str] = (
        ...
        #   solution since all LaunchBrowsers have always assumed the correct
    ...
    text_mime_types: ElementsType[str] = (
        "text/cmd",  # commands; subtype resident in Gecko LaunchBrowsers like Firefox 3.5
        ...
        # optional and there is no need to use it at all since all LaunchBrowsers have always assumed the correct default
