...
class Provider(BaseProvider):
    ...
    application_mime_types: ElementsType[str] = (
        ...
        #   solution since all launch_browsers have always assumed the correct
    ...
    text_mime_types: ElementsType[str] = (
        "text/cmd",  # commands; subtype resident in Gecko launch_browsers like Firefox 3.5
        ...
        # optional and there is no need to use it at all since all launch_browsers have always assumed the correct default
